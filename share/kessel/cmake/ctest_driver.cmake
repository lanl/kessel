...
if("$ENV{CI_PIPELINE_SOURCE}" STREQUAL "merge_request_event")
  set(CTEST_BUILD_NAME "$ENV{KESSEL_SPACK_ENV}, source=$ENV{CI_MERGE_REQUEST_SOURCE_BRANCH_NAME}, target=$ENV{CI_MERGE_REQUEST_TARGET_BRANCH_NAME}, MR=$ENV{CI_MERGE_REQUEST_IID}")
else()
  set(CTEST_BUILD_NAME "$ENV{KESSEL_SPACK_ENV}, Branch=$ENV{CI_COMMIT_REF_NAME}")
endif()
